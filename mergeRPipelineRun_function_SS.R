...
readData = function(samplePathList, output.dir){
  ...
  stats_cols = c("input","successfully_clipped","failed_quality_filter","failed_homopolymer_filter",
                 "UniVec_contaminants","rRNA","reads_used_for_alignment","genome","miRNA_sense","miRNA_antisense",
